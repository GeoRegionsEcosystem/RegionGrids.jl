import{_ as s,c as n,o as e,ai as i}from"./chunks/framework.DFffitLo.js";const h=JSON.parse('{"title":"Creating a RegionGrid","description":"","frontmatter":{},"headers":[],"relativePath":"tutorials/create.md","filePath":"tutorials/create.md","lastUpdated":null}'),t={name:"tutorials/create.md"};function l(o,a,p,d,c,r){return e(),n("div",null,a[0]||(a[0]=[i(`<h1 id="Creating-a-RegionGrid" tabindex="-1">Creating a RegionGrid <a class="header-anchor" href="#Creating-a-RegionGrid" aria-label="Permalink to &quot;Creating a RegionGrid {#Creating-a-RegionGrid}&quot;">​</a></h1><p>Using RegionGrids.jl</p><p>In this section, we go through the basic steps of creating a RegionGrid for <code>RectRegion</code>s and <code>PolyRegion</code>s. See if you can spot the differences between the RegionGrids generated by the two different types.</p><h3 id="setup" tabindex="-1">Setup <a class="header-anchor" href="#setup" aria-label="Permalink to &quot;Setup&quot;">​</a></h3><div class="language-@example vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">@example</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>using GeoRegions</span></span>
